...
const recetaCreate = async (req, res) => {
  ...
  await Recipes.create({
    ...
    malt2Amount: req.body.malt2Amount,
    ...
    hop1Moment: req.body.hop1Moment,
    hop2: req.body.hop2,
    hop2Amount: req.body.hop2Amount,
    hop2Moment: req.body.hop2Moment,
    hop3: req.body.hop3,
    hop3Amount: req.body.hop3Amount,
    hop3Moment: req.body.hop3Moment,
  ...
  Recipes.findOne({
    where: { id: id },
      ...
      let recetaToEdit = {
        ...
        malt2: recipe.malt2,
        malt2Amount: recipe.malt2Amount,
        malt3: recipe.malt3,
        ...
        hop1Moment: recipe.hop1Moment,
        hop2: recipe.hop2,
        hop2Amount: recipe.hop2Amount,
        hop2Moment: recipe.hop2Moment,
        hop3: recipe.hop3,
        hop3Amount: recipe.hop3Amount,
        hop3Moment: recipe.hop3Moment,
        yeast: recipe.yeast,
